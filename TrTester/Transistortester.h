...
const uint16_t RLtab[] MEM_TEXT = {
	/*  300 */ static_cast<uint16_t>(161615107.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  325 */ static_cast<uint16_t>(148790151.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  350 */ static_cast<uint16_t>(137796673.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  375 */ static_cast<uint16_t>(128268372.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  400 */ static_cast<uint16_t>(119930523.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  425 */ static_cast<uint16_t>(112573043.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  450 */ static_cast<uint16_t>(106032531.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  475 */ static_cast<uint16_t>(100179988.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  500 */ static_cast<uint16_t>( 94912216.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  525 */ static_cast<uint16_t>( 90145671.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  550 */ static_cast<uint16_t>( 85812001.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  575 */ static_cast<uint16_t>( 81854741.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  600 */ static_cast<uint16_t>( 78226835.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  625 */ static_cast<uint16_t>( 74888757.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  650 */ static_cast<uint16_t>( 71807063.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  675 */ static_cast<uint16_t>( 68953262.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  700 */ static_cast<uint16_t>( 66302933.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  725 */ static_cast<uint16_t>( 63835026.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  750 */ static_cast<uint16_t>( 61531294.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  775 */ static_cast<uint16_t>( 59375846.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  800 */ static_cast<uint16_t>( 57354779.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  825 */ static_cast<uint16_t>( 55455872.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  850 */ static_cast<uint16_t>( 53668345.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  875 */ static_cast<uint16_t>( 51982646.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  900 */ static_cast<uint16_t>( 50390288.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  925 */ static_cast<uint16_t>( 48883700.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  950 */ static_cast<uint16_t>( 47456108.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/*  975 */ static_cast<uint16_t>( 46101432.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1000 */ static_cast<uint16_t>( 44814201.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1025 */ static_cast<uint16_t>( 43589478.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1050 */ static_cast<uint16_t>( 42422794.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1075 */ static_cast<uint16_t>( 41310098.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1100 */ static_cast<uint16_t>( 40247707.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1125 */ static_cast<uint16_t>( 39232264.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1150 */ static_cast<uint16_t>( 38260704.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1175 */ static_cast<uint16_t>( 37330225.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1200 */ static_cast<uint16_t>( 36438256.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1225 */ static_cast<uint16_t>( 35582436.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1250 */ static_cast<uint16_t>( 34760595.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1275 */ static_cast<uint16_t>( 33970731.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1300 */ static_cast<uint16_t>( 33210996.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1325 */ static_cast<uint16_t>( 32479683.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1350 */ static_cast<uint16_t>( 31775210.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1375 */ static_cast<uint16_t>( 31096111.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5),
	/* 1400 */ static_cast<uint16_t>( 30441023.0 / (PIN_RM + PIN_RP + R_L_VAL) + 0.5)
};
...
const uint16_t RHtab[] PROGMEM = { 
  static_cast<uint16_t>(44814201./R_H_VAL+0.5),   // 1000 mV
  static_cast<uint16_t>(42422794./R_H_VAL+0.5),   // 1050 mV
  static_cast<uint16_t>(40247707./R_H_VAL+0.5),   // 1100 mV
  static_cast<uint16_t>(38260704./R_H_VAL+0.5),   // 1150 mV
  static_cast<uint16_t>(36438256./R_H_VAL+0.5),   // 1200 mV
  static_cast<uint16_t>(34760595./R_H_VAL+0.5),   // 1250 mV
  static_cast<uint16_t>(33210996./R_H_VAL+0.5),   // 1300 mV
  static_cast<uint16_t>(31775210./R_H_VAL+0.5),   // 1350 mV
  static_cast<uint16_t>(30441023./R_H_VAL+0.5)    // 1400 mV
  };
